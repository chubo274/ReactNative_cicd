...
SVC_NAME="actions.runner.chubo274-ReactNative_cicd.chubos-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (chubo274-ReactNative_cicd.chubos-MacBook-Pro)"
